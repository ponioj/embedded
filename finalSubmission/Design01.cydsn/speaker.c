...
/***********************************************
 * Plays the startup music for the program.
 ***********************************************/
...
/***********************************************
 * Plays the "Fail Song" from The Price is Right
 ***********************************************/
void Play_song_one() {
    // F#, C#, B, C#
    // C3 D3 C2 G2
...
/***********************************************
 * Plays the passed in note for the passed in
 * amount of time.
 * @param toneFrequency the frequency to play
...
/***********************************************
 * File that calculates the period delay to 
