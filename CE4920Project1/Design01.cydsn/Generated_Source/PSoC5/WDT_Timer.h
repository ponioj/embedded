...
#define WDT_Timer_INIT_PERIOD             99999u
#define WDT_Timer_INIT_CAPTURE_MODE       ((uint8)((uint8)4u << WDT_Timer_CTRL_CAP_MODE_SHIFT))
...
#define WDT_Timer_INIT_INT_CAPTURE_COUNT  ((uint8)((uint8)(2u - 1u) << WDT_Timer_CTRL_INTCNT_SHIFT))
...
***************************************/
    ...
    ***************************************/
    ...
    #define WDT_Timer_CONTROL             (* (reg8 *) WDT_Timer_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__CONTROL_REG )
        ...
        #define WDT_Timer_CAPTURE_LSB         (* (reg8 *) WDT_Timer_TimerUDB_sT24_timerdp_u0__F0_REG )
        #define WDT_Timer_CAPTURE_LSB_PTR       ((reg8 *) WDT_Timer_TimerUDB_sT24_timerdp_u0__F0_REG )
        #define WDT_Timer_PERIOD_LSB          (* (reg8 *) WDT_Timer_TimerUDB_sT24_timerdp_u0__D0_REG )
        #define WDT_Timer_PERIOD_LSB_PTR        ((reg8 *) WDT_Timer_TimerUDB_sT24_timerdp_u0__D0_REG )
        #define WDT_Timer_COUNTER_LSB         (* (reg8 *) WDT_Timer_TimerUDB_sT24_timerdp_u0__A0_REG )
        #define WDT_Timer_COUNTER_LSB_PTR       ((reg8 *) WDT_Timer_TimerUDB_sT24_timerdp_u0__A0_REG )
    #elif(WDT_Timer_Resolution <= 16u) /* 8-bit Timer */
        #if(CY_PSOC3) /* 8-bit addres space */
            #define WDT_Timer_CAPTURE_LSB         (* (reg16 *) WDT_Timer_TimerUDB_sT24_timerdp_u0__F0_REG )
            #define WDT_Timer_CAPTURE_LSB_PTR       ((reg16 *) WDT_Timer_TimerUDB_sT24_timerdp_u0__F0_REG )
            #define WDT_Timer_PERIOD_LSB          (* (reg16 *) WDT_Timer_TimerUDB_sT24_timerdp_u0__D0_REG )
            #define WDT_Timer_PERIOD_LSB_PTR        ((reg16 *) WDT_Timer_TimerUDB_sT24_timerdp_u0__D0_REG )
            #define WDT_Timer_COUNTER_LSB         (* (reg16 *) WDT_Timer_TimerUDB_sT24_timerdp_u0__A0_REG )
            #define WDT_Timer_COUNTER_LSB_PTR       ((reg16 *) WDT_Timer_TimerUDB_sT24_timerdp_u0__A0_REG )
        #else /* 16-bit address space */
            #define WDT_Timer_CAPTURE_LSB         (* (reg16 *) WDT_Timer_TimerUDB_sT24_timerdp_u0__16BIT_F0_REG )
            #define WDT_Timer_CAPTURE_LSB_PTR       ((reg16 *) WDT_Timer_TimerUDB_sT24_timerdp_u0__16BIT_F0_REG )
            #define WDT_Timer_PERIOD_LSB          (* (reg16 *) WDT_Timer_TimerUDB_sT24_timerdp_u0__16BIT_D0_REG )
            #define WDT_Timer_PERIOD_LSB_PTR        ((reg16 *) WDT_Timer_TimerUDB_sT24_timerdp_u0__16BIT_D0_REG )
            #define WDT_Timer_COUNTER_LSB         (* (reg16 *) WDT_Timer_TimerUDB_sT24_timerdp_u0__16BIT_A0_REG )
            #define WDT_Timer_COUNTER_LSB_PTR       ((reg16 *) WDT_Timer_TimerUDB_sT24_timerdp_u0__16BIT_A0_REG )
        #endif /* CY_PSOC3 */
    #elif(WDT_Timer_Resolution <= 24u)/* 24-bit Timer */
        #define WDT_Timer_CAPTURE_LSB         (* (reg32 *) WDT_Timer_TimerUDB_sT24_timerdp_u0__F0_REG )
        #define WDT_Timer_CAPTURE_LSB_PTR       ((reg32 *) WDT_Timer_TimerUDB_sT24_timerdp_u0__F0_REG )
        #define WDT_Timer_PERIOD_LSB          (* (reg32 *) WDT_Timer_TimerUDB_sT24_timerdp_u0__D0_REG )
        #define WDT_Timer_PERIOD_LSB_PTR        ((reg32 *) WDT_Timer_TimerUDB_sT24_timerdp_u0__D0_REG )
        #define WDT_Timer_COUNTER_LSB         (* (reg32 *) WDT_Timer_TimerUDB_sT24_timerdp_u0__A0_REG )
        #define WDT_Timer_COUNTER_LSB_PTR       ((reg32 *) WDT_Timer_TimerUDB_sT24_timerdp_u0__A0_REG )
    #else /* 32-bit Timer */
            ...
            #define WDT_Timer_CAPTURE_LSB         (* (reg32 *) WDT_Timer_TimerUDB_sT24_timerdp_u0__32BIT_F0_REG )
            #define WDT_Timer_CAPTURE_LSB_PTR       ((reg32 *) WDT_Timer_TimerUDB_sT24_timerdp_u0__32BIT_F0_REG )
            #define WDT_Timer_PERIOD_LSB          (* (reg32 *) WDT_Timer_TimerUDB_sT24_timerdp_u0__32BIT_D0_REG )
            #define WDT_Timer_PERIOD_LSB_PTR        ((reg32 *) WDT_Timer_TimerUDB_sT24_timerdp_u0__32BIT_D0_REG )
            #define WDT_Timer_COUNTER_LSB         (* (reg32 *) WDT_Timer_TimerUDB_sT24_timerdp_u0__32BIT_A0_REG )
            #define WDT_Timer_COUNTER_LSB_PTR       ((reg32 *) WDT_Timer_TimerUDB_sT24_timerdp_u0__32BIT_A0_REG )
        #endif /* CY_PSOC3 || CY_PSOC5 */ 
    #endif

    #define WDT_Timer_COUNTER_LSB_PTR_8BIT       ((reg8 *) WDT_Timer_TimerUDB_sT24_timerdp_u0__A0_REG )
